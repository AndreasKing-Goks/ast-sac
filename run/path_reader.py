...
from path_collect_setup import get_path_collector
...
class PathReader():
    '''
    Takes a path, simulate over, then plot the data
    '''
    def __init__(self, paths, idx):
        ...
        # Get action list
        self.actions = self.path['actions']
        
    def read_paths(self):
        # Initialize
        act_idx = 0
        
        while act_idx < len(self.actions):
            # Get action
