...
from run_colav.ship_in_transit.sub_systems.ship_model import SimpleShipModel
from run_colav.ship_in_transit.sub_systems.controllers import ThrustFromSpeedSetPoint, HeadingByRouteController, HeadingBySampledRouteController
from run_colav.ship_in_transit.sub_systems.obstacle import PolygonObstacle
from run_colav.ship_in_transit.evaluation.termination_flags import get_termination_status
from run_colav.ship_in_transit.evaluation import check_condition
from run_colav.ship_in_transit.sub_systems.sbmpc import SBMPC

from run_colav.ship_in_transit.evaluation.get_env_info import get_env_info
...
@dataclass
class ShipAssets:
    ship_model: SimpleShipModel
    speed_controller: ThrustFromSpeedSetPoint
